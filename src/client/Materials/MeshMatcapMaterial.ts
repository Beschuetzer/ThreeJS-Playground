...
//Do a google search for matcap to get textures
//high performance as it is basically MeshNormalMaterial but using the matcap texture for color gradient info (all shading and shine comes from texture image)
