//The SpecularMap is a texture image that affects the /specular surface highlight, and in the case of the //MeshPhongMaterial, it also affects the environment map.
